      ...
      <div className='burger-container' onClick={() => setBurgerActive(!burgerActive)}>
        ...
        <div className='nav-open'>
          <ul className="nav-links">
              <NavLink to='/about' activeClassName="nav-selected" onClick={() => tl.reverse()}><li>ABOUT</li></NavLink>
              <NavLink to='/projects' activeClassName="nav-selected" onClick={() => tl.reverse()}><li>PROJECTS</li></NavLink>
              <NavLink to='/contact' activeClassName="nav-selected" onClick={() => tl.reverse()}><li>CONTACT</li></NavLink>
          </ul>
