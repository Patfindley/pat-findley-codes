...
const AboutMe = () => {
  return (
    ...
    I looked into web development, dipped my toes in the water with some <a className='active-link' style={{animationDelay: "0.14s"}} href='https://www.codecademy.com/' target='_blank' rel="noreferrer">codecademy</a> courses <br/>
    ...
    I enrolled in <a className='active-link' style={{animationDelay: "0.21s"}} href="https://turing.io/" target='_blank' rel="noreferrer"> Turing School of Software and Design's</a> Front-End program, unaware it would become the first accredited coding bootcamp, <br/> 
