...
const AboutMe = () => {
  return (
    ...
    <p className='about-me-body'> I'm a web developer, father, husband, service industry veteran, <a className='active-link'
    style={{animationDelay: "0.07s"}} href='https://herenowband.com/' target='_blank' rel="noreferrer">musician</a>, creator, doer, and (aspiring) optimist.<br/>
    <br/>
    When the world started shutting down in 2020, Everything I had spent the previous years building and working on came to a screeching halt.
    ...
    <br/>
    I spent some time with my daughter, who was 1 at the time, and I started thinking about who I was, and what else I was capable of.
    13 years in the service industry felt like enough.
    I looked into web development, dipped my toes in the water with some <a className='active-link' style={{animationDelay: "0.14s"}} href='https://www.codecademy.com/' target='_blank' rel="noreferrer">codecademy</a> courses
    ...
    I enrolled in <a className='active-link' style={{animationDelay: "0.21s"}} href="https://turing.io/" target='_blank' rel="noreferrer"> Turing School of Software and Design's</a> Front-End program, unaware it would become the first accredited coding bootcamp, 
    and can't believe what I was able to learn in such a short time. 
    I built <strong>A LOT</strong> of basic vanilla JS apps, And that really laid a strong foundation to start building
    <strong>A LOT</strong> of React Apps.<br/>
    <br/>
    In the midst of speed-running React applications, I found a passion for creating alluring user interfaces.
