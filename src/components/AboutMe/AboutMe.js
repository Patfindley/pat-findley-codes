...
const AboutMe = () => {
  return (
    ...
    <p className='about-me-body'> I'm a web developer, father, husband, service industry veteran, <a className='active-link' href='https://herenowband.com/' target='_blank' rel="noreferrer">musician</a>, creator, doer, and (aspiring) optimist.<br/>
    <br/>
    ...
    I looked into web development, dipped my toes in the water with some <a className='active-link' href='https://www.codecademy.com/' target='_blank' rel="noreferrer">codecademy</a> courses <br/>
    ...
    I enrolled in <a className= 'active-link' href="https://turing.io/" target='_blank' rel="noreferrer"> Turing School of Software and Design's</a> Front-End program, unaware it would become the first accredited coding bootcamp, <br/> 
